...
import CreateRouteLocationModal from '../components/CreateRouteLocationModal';
...
const RouteLocationsTab: React.FC<IRouteLocationsProps> = ({
  route,
  setRoute,
  setSuccess,
}) => {
...
export default RouteLocationsTab;
