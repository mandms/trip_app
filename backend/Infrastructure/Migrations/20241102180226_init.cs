    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=0;POINT (48.858779767208894 2.294590215790281)"), new DateTime(2024, 11, 2, 18, 2, 25, 738, DateTimeKind.Utc).AddTicks(876), "Moment description 1", 4, 1L },
                    { 2L, (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=0;POINT (55.751165864532894 37.61726058361952)"), new DateTime(2024, 11, 2, 18, 2, 25, 738, DateTimeKind.Utc).AddTicks(879), "Moment description 2", 5, 2L },
                    { 3L, (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=0;POINT (50.04278538093594 87.40137428089643)"), new DateTime(2024, 11, 2, 18, 2, 25, 738, DateTimeKind.Utc).AddTicks(882), "Moment description 3", 3, 3L }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2024, 11, 2, 18, 2, 25, 738, DateTimeKind.Utc).AddTicks(765), 1L, "Text 1" },
                    { 2L, new DateTime(2024, 11, 2, 18, 2, 25, 738, DateTimeKind.Utc).AddTicks(767), 2L, "Text 2" },
                    { 3L, new DateTime(2024, 11, 2, 18, 2, 25, 738, DateTimeKind.Utc).AddTicks(768), 3L, "Text 3" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2024, 11, 2, 18, 2, 25, 738, DateTimeKind.Utc).AddTicks(844), 5, 3L, "Text 1", 1L },
                    { 2L, new DateTime(2024, 11, 2, 18, 2, 25, 738, DateTimeKind.Utc).AddTicks(846), 4, 1L, "Text 2", 2L },
                    { 3L, new DateTime(2024, 11, 2, 18, 2, 25, 738, DateTimeKind.Utc).AddTicks(848), 3, 2L, "Text 3", 3L }
                });
